<div class="grid grid-cols-6 gap-6 py-3">
    {!! Form::label('lawyer_id', 'Select a lawyer',
     ['class' => 'block text-sm font-medium text-gray-700']) !!}
    <div class="col-span-4 sm:col-span-2">
        {!! Form::select('lawyer_id', $lawyers, old('lawyer_id'),
        ['class' => 'mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm']) !!}
        <div class="text-red-600 mt-1 text-sm">{!! $errors->first('lawyer_id') !!}</div>
    </div>
</div>
<div class="grid grid-cols-6 gap-6 py-3">
    ...
    <div class="col-span-6 sm:col-span-3">
        <input type="datetime-local" id="valid_from" name="valid_from" value="{{ old('valid_from') }}"
               class="'mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm'">
        <div class="text-red-600 mt-1 text-sm">{!! $errors->first('valid_from') !!}</div>
    </div>
</div>
<div class="grid grid-cols-6 gap-6 py-3">
    ...
    <div class="col-span-6 sm:col-span-3">
        <input type="datetime-local" id="valid_to" name="valid_to" value="{{ old('valid_to') }}"
               class="'mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm'">
        <div class="text-red-600 mt-1 text-sm">{!! $errors->first('valid_to') !!}</div>
    </div>
</div>
